...
aggregate.data = do.call(rbind, lapply(list.files(path="data/aggregates", pattern="*.csv", full.names=T), 
...
dispersal.aneuploidy.heatmap = ggplot(biopsy.5.data, aes(x = Aneuploidy*100, 
                                                         y = Dispersal, 
