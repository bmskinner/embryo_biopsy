...
## Assay aneuploidy - multicolour FISH
...
Are biopsies really useful?

_Solution_:

Create a toy embryo that we can repeatedly biopsy 
...
- A biopsy is not useful in predicting an individual embryo's state
