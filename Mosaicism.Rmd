...
heatmap.1x5 = ggplot(clumpy.embryos.1x5, aes(x = PctBiopsyAneuploid, y = aneuploidy, fill=PctTotal))+
  ...
  geom_rect(xmin=70, xmax=110, ymin=0.775, ymax=1.025, 
            fill=NA, col="white", size=1)+
  scale_fill_viridis_c(breaks = seq(0, 100, 10), limits = c(0, 90)) +
...
```{r pgdis-2x5, eval=T, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height=3, fig.cap="PGDIS classes cannot be reliably inferred from biopsy results. Comparison of low, mid and high dispersals." }
