...
```{r, echo=F, warning=F, fig.cap="Example 200 cell embryo with 20% aneuploidy, dispersed"}
...
```{r, echo=F, warning=F, fig.cap="Example 200 cell embryo with 20% aneuploidy, clustered"}
e = tessera::create.embryo(n.cells = 200, 
                           prop.aneuploids = 0.2, 
                           dispersions = 0, 
...
```{r, eval=T, echo=FALSE, cache=T, fig.show='hold', fig.cap="Sampling more than 5% of the embryo is not more informative in most cases"}
...
```{r, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Biopsy size does not affect accuracy past ~5%"}
