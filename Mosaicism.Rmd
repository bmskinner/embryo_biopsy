...
At a first approximation, two 5 cell biopsies appear to offer a slight improvement over a single 10 cell biopsy. The correct PGDIS classification (low level) is assigned in `r pgdis.accuracy(g$Avg, 5, 20)`% of 2x5 biopsies rather than `r pgdis.accuracy(b10, 10, 20)`% in a 10-cell biopsy and `r pgdis.accuracy(b, 5, 20)`% in a single 5-cell biopsy.
