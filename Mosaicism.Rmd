...
```{r validate-hyper-calc, eval=F, echo=FALSE, warning=F, message=F, cache=T}
...
```{r validate-hyper-plot, eval=F, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height=6, fig.width=7, fig.cap="At high dispersal, biopsy results (bars) are similar to but not precisely the hypergeometric distribution (green line)" }
...
```{r validate-cluster-calc, eval=F, echo=FALSE, warning=F, message=F, cache=T }
...
```{r validate-cluster-plot, eval=F, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height=9, fig.width=7, fig.cap="At low dispersal, cells remain clustered" }
