...
We start with an embryo with 20% aneuploidy with no dispersal.
...
p3 = plot.pgdis(b, 5) + labs(title = "5 cell")

p4 = plot.pgdis(g$Avg, 5) + labs(title = "2x5 cell")
# pgdis.accuracy(g$Avg, 5, 20)

p5 = plot.pgdis(b10, 10) + labs(title = "10 cell")
...
There is an improvement versus a 1x5 biopsy, but not an improvement that gives more confidence in predicting embryo aneuploidy when dispersal is low.
