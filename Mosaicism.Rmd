...
```{r first_embryo, echo=F, warning=F, fig.show="hold", fig.cap="Example 200 cell embryo with 20% aneuploidy, dispersed"}
...
```{r first_embryo_biopsies, echo=F, fig.cap="Percentage of aneuploid cells in each biopsy"}
...
```{r second_embryo, echo=F, warning=F, fig.show="hold", fig.cap="Example 200 cell embryo with 20% aneuploidy, clustered"}
e = tessera::Embryo(n.cells = 200, 
                    n.chrs = 1,
                    prop.aneuploid = 0.2, 
                    dispersal = 0, 
...
```{r second_embryo_biopsies, echo=F, fig.cap="Percentage of aneuploid cells in each biopsy"}
...
```{r aneuploidy_effect, echo=F, warning=F, message=F, cache=T, fig.show = 'hold', fig.cap="Accuracy is lowest when half the embryo is aneuploid (animated gif)"}
...
```{r aneuploidy_step, echo=FALSE, cache=T, fig.show='hold', fig.cap="Embryos with high dispersal of aneuploid cells"}
...
```{r aneuploidy_pgdis, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="PGDIS classes for embryos with A) 10% (euploid) and B) 50% aneuploidy (high-level) demonstrate the difference in accuracy from changing aneuploidy level" }
...
```{r aneuploidy_pgdis_all, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height=3, fig.cap=paste("PGDIS classification accuracy by aneuploidy level. Error bars show standard deviation across", n.replicates, "replicates") }
...
```{r dispersal_effect, echo=F, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Biopsy accuracy is higher when aneuploid cells are dispersed  (animated gif)"}
...
```{r dispersal_step, echo=FALSE, cache=T, fig.show='hold', fig.cap="Lower dispersal of cells reduces biopsy accuracy"}
...
```{r dispersal_v_aneuploidy, echo=FALSE, message=F, warning=F, cache=T, fig.show='hold', fig.cap="Embryos with varying dispersal of aneuploid cells  (animated gif)"}
...
```{r dispersal_pgdis, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="PGDIS classes for embryos with 20% aneuploidy (low level) with A) low and B) high dispersal demonstrate the difference in accuracy from changing dispersal. In this case, higher dispersal yields a higher accuracy." }
...
```{r dispersal_pgdis_all, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap= paste("PGDIS classification accuracy by dispersion level. Error bars show standard deviation across", n.replicates, "replicates") }
...
```{r dispersal_aneuploidy_pgdis, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="PGDIS classification accuracy by aneuploidy and dispersion level" }
...
```{r biopsy_size_increase, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Biopsy size affects accuracy  (animated gif)"}
...
```{r biopsy_size_step, eval=T, echo=FALSE, cache=T, fig.show='hold', fig.cap="Biopsy size does not drastically affect the accuracy of the biopsy beyond about 5% of the embryo"}
...
```{r biopsy_size_step_5_10, eval=T, echo=FALSE, cache=T, fig.show='hold', fig.height=3, fig.cap="Changing biopsy size from 5 to 10 cells does not dramatically improve accuracy"}
...
```{r embryo_size_effect, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Sampling more than 5% of the embryo is not more informative regardless of embryo size  (animated gif)"}
...
```{r biopsy_size_pgdis_effect, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap=paste("Biopsy size affects the accuracy of PGDIS classification. Error bars show standard deviation across", n.replicates, "replicates")}
...
```{r biopsy_size, eval=T, echo=FALSE, cache=T, fig.show='hold', fig.cap="Biopsy size does not drastically affect the accuracy of the biopsy beyond about 5% of the embryo"}
...
```{r biopsy_size_pgdis, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap=paste("Biopsy and embryo size variation does not greatly affect the model results with a biopsy sd of 1. Error bars show standard deviation across", n.replicates, "replicates")}
combinations = expand.grid(biopsy.sizes = seq(3, 50, 1),
                           seeds   = 1:n.replicates)
...
```{r aneuploidy_dispersal_combinations, eval=T, echo=FALSE, warning=F, message=F, cache=T}
...
```{r aneuploidy_dispersal_fig, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height=3, fig.width=4, fig.cap="Number of biopsies across all embryos with aneuploid cells. A biopsy with 1 aneuploid cell can come from a range of possible embryos."}
...
```{r possible_embryo_fig, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Possible embryo parameters matching a biopsy with one aneuploid cell"}
...
```{r full_possible_embryo_fig, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="The probability space of 5-cell biopsies for a 200 cell embryo"}
...
```{r pgdis_classifictions, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.cap="Liklihood of each PGDIS class producing a 5-cell biopsy with a single aneuploid cell", fig.height= 3, fig.width=3 }
...
```{r heatmap_1x5, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height= 3, fig.cap="Confidently relating biopsy aneuploidy to embryo aneuploidy is only possible if dispersal is high. White boxes show PGDIS classification boundaries." }
...
```{r pgdis_1x5, eval=T, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height= 3, fig.cap="PGDIS classes cannot be inferred from biopsy results. Comparison of low, mid and high dispersals." }
...
```{r heatmap_1x10, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height= 3, fig.cap="Biopsy aneuploidy correlation with embryo for 1x10 biopsies" }
combinations = expand.grid(aneuploidies = seq(0, 1, 0.05),
                           dispersals   = seq(0, 1, 0.05),
                           seeds        = 1:n.replicates)
...
heatmap.1x10 = ggplot(clumpy.embryos.1x10, aes(x = PctBiopsyAneuploid, y = aneuploidy, fill=PctTotal))+
  ...
  geom_rect(xmin=75, xmax=105, ymin=0.775, ymax=1.025, 
            fill=NA, col="white", size=1)+
  scale_fill_viridis_c(breaks = seq(0, 60, 10), limits = c(0, 60)) +
  labs(x = "Biopsy aneuploidy",
       y = "Embryo aneuploidy",
       fill = "Percentage\nof biopsies") +
  scale_y_continuous(breaks = seq(0, 1, 0.1)) +
...
```{r pgdis_1x10, eval=T, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height= 3, fig.cap="Correct PGDIS classes from 1x10 biopsy results. Comparison of low, mid and high dispersals." }
...
```{r function_2x5, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height= 3, fig.cap="Taking two five cell biopsies does not improve greatly over one 10 cell biopsy"}
...
```{r calc_2x5, eval=T, echo=FALSE, warning=F, message=F, cache=T}
combinations = expand.grid(aneuploidies = seq(0, 1, 0.05),
                           dispersals   = seq(0, 1, 0.05),
...
```{r heatmap_2x5, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height=9, fig.cap="A) 1x5 B) 1x10 C) 2x5. Taking two 5-cell biopsies does not overcome the issues in interpreting biopsy aneuploidy"}
...
```{r pgdis_2x5, eval=T, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height=3, fig.cap="PGDIS classes cannot be reliably inferred from biopsy results. Comparison of low, mid and high dispersals." }
...
The results of sampling a fully dispersed embryo should follow a hypergeometric distribution (sampling without replacement). We can make a simple simulation of this.

```{r validate_hyper, eval=T, echo=FALSE, warning=F, message=F, cache=F, fig.show='hold', fig.height=6, fig.width=7, fig.cap="At high dispersal, biopsy results (bars) reflect the hypergeometric distribution (green line)" }
...
We see that there is good agreement between the expected theoretical hypergeometric distribution and the actual biopsy results, giving us confidence that the dispersal parameter is evenly distributing aneuploid cells.
...
```{r validate_cluster, eval=T, echo=FALSE, warning=F, message=F, cache=T, fig.show='hold', fig.height=3, fig.width=7, fig.cap="At low dispersal, cells are remaining clustered as expected" }
